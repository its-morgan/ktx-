...
<div class="min-h-screen">
    ...
    <nav class="fixed bottom-0 left-0 right-0 z-50 border-t border-gray-200 bg-white p-2 shadow-inner lg:hidden">
        <div class="mx-auto flex w-full max-w-lg items-center justify-between">
            <a href="{{ route('admin.trangchu') }}" class="flex flex-col items-center text-xs text-gray-600 hover:text-gray-900">
            ...
            <a href="{{ route('admin.quanlyhoadon') }}" class="flex flex-col items-center text-xs text-gray-600 hover:text-gray-900">
            ...
            <a href="{{ route('admin.quanlybaohong') }}" class="flex flex-col items-center text-xs text-gray-600 hover:text-gray-900">
            ...
            <a href="{{ route('admin.quanlysinhvien') }}" class="flex flex-col items-center text-xs text-gray-600 hover:text-gray-900">
